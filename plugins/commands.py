...
async def start(client:Client, message): 
    ...
    if data and data.startswith("allfiles"):
        ...
        for file in files:
            ...
            btn = [[
                InlineKeyboardButton("𝗛𝗼𝗹𝗹𝘆𝘄𝗼𝗼𝗱", url="http://t.me/+NoN2pWdXfdphNjU0"),
                InlineKeyboardButton("𝗕𝗼𝗹𝗹𝘆𝘄𝗼𝗼𝗱", url="http://t.me/+xZc_-RN6_TAwMTVk")
            ]]
...
async def save_tutorial(client, message):
    ...
    try:
        ...
        return await message.reply_text("<b>Command Incomplete!!\n\nuse like this -</b>\n\n<code>/set_caption https://t.me/movie344</code>")    
